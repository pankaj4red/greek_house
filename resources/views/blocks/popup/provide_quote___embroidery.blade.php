...
@section ('javascript')
    <script>
        ...
        function quote{{ $product->id }}() {
            ...
            $.ajax({
                url: '{{ route('system::quick_manager_quote', ['embroidery']) }}' + '?pid=' + product + '&eqf=' + estimatedQuantityFrom + '&eqt=' + estimatedQuantityTo + '&dh=' + designHours + '&mu=' + markup + '&pc=' + productCount,
                type: 'GET',
