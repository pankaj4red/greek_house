                            ...
                            <div class="col-sm-9">
                                <p class="form-control-static">
                                    @foreach (garment_size_list() as $size)
                                        {!! Form::checkbox('size_' . $size->short, 'yes', isset($model['size_' . $size->short])?$model['size_' . $size->short]:''=='yes') !!} {{ $size->short }}
                                        <br/>
                                    @endforeach
                                </p>
                            </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" action-area pull-right">
                <a href="{{ route('admin::product::read', [$model['id']]) }}" class="btn btn-default">Back</a>
