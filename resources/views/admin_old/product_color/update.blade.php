...
@section ('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Update Product Color</h1>
        </div>
    </div>
    {!! Form::model($model) !!}
    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="file-list" id="color_image_div">
                                    ...
                                    {{Form::hidden('prefix','product_color.update-' . $model->id , ['id' => 'prefix'])}}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label class="radio-inline">
                                    {{ Form::radio('active', 'yes', $active == 'yes') }}Yes
                                </label>
                                <label class="radio-inline">
                                    {{ Form::radio('active', 'no', $active != 'yes') }}No
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" action-area pull-right">
                <a href="{{ route('admin::product::read', [$productId]) }}" class="btn btn-default">Back</a>
