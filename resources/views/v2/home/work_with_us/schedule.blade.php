...
@section('title', 'Work With Us - Sign Up')
            ...
            <div class="col-md-12">
                <div class="panel panel-box">
                    ...
                    <div class="panel-body" id="container-w9">
                        ...
                        <div class="calendly-inline-widget" data-url="https://calendly.com/greekhouse/welcome-call-new-customers" style="min-width:320px;height:580px;"></div>
