...
@section ('title', 'Profile - Edit Address')
...
@section ('content')
    ...
    <div class="container">
        <div class="form-header">
            <h1><i class="icon icon-info"></i><span class="icon-text">Edit Address</span></h1>
            <hr/>
        </div>
        @if (messages_exist())
            {!! messages_output() !!}
        ...
        <div class="action-row">
            <button type="submit" name="delete" value="delete" class="button-back btn btn-default btn-danger pull-left">
                Delete
            </button>
            <a href="{{ route('profile::index') }}" class="button-back btn btn-default back-btn">Cancel</a>
            <button type="submit" name="shipping" value="shipping" class="btn btn-default btn-info">Make Shipping
                Address
            </button>
