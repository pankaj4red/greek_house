            ...
            <div class="col-md-12">
                <table class="view_links_table">
                    ...
                    <tr class="view_links_tr">
                        ...
                        <td><a href="{{ route('art_director::awaiting_for_designer') }}" class="active">Awaiting for
                                Designer</a></td>
...
@section ('javascript')
    <script>
        $('#filter-embellishment').change(function () {
            window.location = '{{ route('art_director::awaiting_for_designer') }}?embellishment=' + $(this).val();
        });
    </script>
@append
