            ...
            <div class="col-md-12">
                <table class="view_links_table">
                    ...
                    <tr class="view_links_tr">
                        ...
                        <td><a href="{{ route('art_director::awaiting_for_customer') }}" class="active">Awaiting for
                                Customer</a></td>
...
@section ('javascript')
    <script>
        $('#filter-embellishment').change(function () {
            window.location = '{{ route('art_director::awaiting_for_customer') }}?embellishment=' + $(this).val();
        });
    </script>
@append
