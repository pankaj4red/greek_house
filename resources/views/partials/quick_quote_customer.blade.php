<div class="quick-quote-popup">
    <div class="quick-quote">
        ...
        <div class="form-row btnbar"><a href="javascript:void(0)" class="btn btn-success pull-left"
                                        id="quick-quote-submit">SUBMIT</a> <a href="javascript:void(0)"
                                                                              class="btn btn-default toggle-quick-quote">Cancel</a>
        </div>
...
@section ('include')
    <?php register_js(static_asset('js/icheck.js')) ?>
@append
