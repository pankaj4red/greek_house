                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;"
                    ...
                    <tr>
                        ...
                        <td valign="top" class="mcnTextContent"
                            ...
                            &nbsp;
                            <div style="text-align: left;"><strong><span style="font-size:18px">URGENT - Follow These Instructions to&nbsp;Keep Your Campaign # - {{ $campaign->id }}
                            ...
                            <ul>
                                <li style="text-align: left;">Collecting Sizes &amp; Payment by: <span
                                            style="color:#FF0000"><strong>{{ date('m/d/Y', strtotime($campaign->getPaymentDeadlineDate())) }}</strong></span>
                                </li>
