                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;"
                    ...
                    <tr>
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px;">
                            <div style="text-align: center;"><strong><span style="font-size:18px">There's A New Order Up For Grabs!</span></strong><br>
                                &nbsp;
                            </div>
                        </td>
                    </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer"
                    ...
                    <tr>
                        <td align="center" valign="middle" class="mcnButtonContent"
                            ...
                            <a class="mcnButton " title="Login To View Order"
        ...
        <tr>
            <td valign="top" class="mcnTextBlockInner">
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;"
                    ...
                    <tr>
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px;">
                            <span style="line-height:21px">{{ $campaign->user->getFullName() }} placed a design request for Campaign # - {{ $campaign->id }}
                                - {{ $campaign->name }}. Please go to&nbsp;</span><a
                                    href="http://www.greekhouse.org/Greekhouse.org" style="line-height: 21px;"
                                    target="_blank">Greekhouse.org</a><span style="line-height:21px">&nbsp;and login into your dashboard to view and claim order.<br>
                                    <br>
                                    Thanks,</span><br style="line-height: 21px;">
                            <span style="line-height:21px">Greek House</span>
                        </td>
                    </tr>
                    </tbody>
                </table>
