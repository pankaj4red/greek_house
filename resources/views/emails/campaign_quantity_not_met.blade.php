                    ...
                    <tr>
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px;">
                            ...
                            <div style="text-align: left;"><strong><span
                                        ...
                                        - {{ $campaign->name }} Did Not Meet Estimated Quantity.</span></strong></div>

                            <div style="text-align: left;"><br
                                        style="color: #2A313A;font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;line-height: 23px;">
                                <span style="color: #1B2432;font-family: proxima-nova,helvetica neue,arial,sans-serif;font-size: 14px;line-height: 20px;white-space: pre-wrap;">It looks like this order closed without meeting the estimated quantity. <u>We re-opened the order and extended the order date for four more days.</u></span><br>
                                &nbsp;
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px;">
                            <span style="color: #2A313A;font-family: open sans,helvetica neue,helvetica,arial,sans-serif;line-height: 23px;">Please make&nbsp;</span><span
                                    style="color: #2A313A;font-family: open sans,helvetica neue,helvetica,arial,sans-serif;line-height: 23px;">sure to double check that all purchases are in before the order closes.<br>
                                    <br>
                                    If you need more time for members to order then you can extend the order close date on your order dashboard.&nbsp;<br>
                                    <br>
