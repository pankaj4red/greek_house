                    ...
                    <tr>
                        ...
                        <td valign="top" class="mcnTextContent"
                            ...
                            <div style="text-align: left;"><br>
                                Your order is currently set to close
                                on&nbsp;<strong>{{ date('m/d/Y', strtotime($campaign->close_date)) }}. </strong>In order
                                for us to process the order on this date&nbsp;the following actions must be met:
                            </div>
                            <ul>
