                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;"
                    ...
                    <tr>
                        ...
                        <td valign="top" class="mcnTextContent"
                            ...
                            &nbsp;
                            <div style="text-align: left;"><strong><span style="font-size:18px">The Design&nbsp;For&nbsp;Campaign # - {{ $campaign->id }}
                            ...
                            <div style="text-align: left;"><br
                                ...
                                @if ($campaign->awaiting_approval_at)
                                    <span style="font-family: open sans, helvetica neue, helvetica, arial, sans-serif"><span
                                                style="line-height:23px">It has been <u><strong>{{ $daysSinceAwaitingApproval }}
                                                    &nbsp;days</strong></u>&nbsp;since the designer has uploaded a proof for this order.<br>
                                    <br>
                                            @endif
