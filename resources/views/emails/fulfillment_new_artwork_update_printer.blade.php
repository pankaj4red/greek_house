        ...
        <tr>
            <td valign="top" class="mcnTextBlockInner">
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;"
                    ...
                    <tr>
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px;">
                            <div style="text-align: left;"><strong><span style="font-size:18px">New Artwork&nbsp;Update&nbsp;For Campaign # - {{ $campaign->id }}
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonContentContainer"
                    ...
                    <tr>
                        <td align="center" valign="middle" class="mcnButtonContent"
                            ...
                            <a class="mcnButton " title="Login To Dashboard To Review New Artwork"
                               ...
                               style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #F1F1F1;">Login
                                To Dashboard To Review New Artwork</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <tr>
            <td valign="top" class="mcnTextBlockInner">
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;"
                    ...
                    <tr>
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px;">
                            <span style="line-height:21px">The new artwork for Campaign # - {{ $campaign->id }}
                                - {{ $campaign->name }} has been updated per your previous request.</span><br>
                            <br>
                            <u style="line-height:21px">Please approve the new art as soon as possible to ensure the
                                order is accurate and on track.</u>
                            <ul>
                                <li><span style="line-height:21px"><strong>If the artwork is correct:</strong>&nbsp;please confirm the new artwork&nbsp;on your dashboard.</span><br>
                                    &nbsp;</li>
                                <li><span style="line-height:21px"><strong>If the artwork is still incorrect:</strong>&nbsp;please mark the artwork as bad and provide very clear and concise reasons for what is wrong and what our designer can do to correct the issue.&nbsp;</span>
                                </li>
                            </ul>
                            <span style="line-height:21px">A Greek House designer will be notified and work to get you an update as quickly as possible.</span>
                        </td>
                    </tr>
                    </tbody>
                </table>
