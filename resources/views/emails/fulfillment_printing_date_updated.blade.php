                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;"
                    ...
                    <tr>
                        <td valign="top" class="mcnTextContent" style="padding: 9px 18px;">
                            ...
                            &nbsp;
                            <div style="text-align: left;"><strong><span style="font-size:18px">The printing date has been set ({{ $campaign->printing_date ? date('m/d/Y', strtotime($campaign->printing_date)) : 'N/A' }}) on Campaign # - {{ $campaign->id }}
