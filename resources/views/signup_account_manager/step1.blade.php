                ...
                <div class="panel panel-default panel-box">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="venmo_username">Venmo Username<i class="required">*</i></label>
                                    {!! Form::text('venmo_username', null, ['class' => 'form-control', 'placeholder' => 'Venmo Username']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="chapter">Graduation Year<i class="required">*</i></label>
                                    {!! Form::select('graduation_year', graduation_year_options(), null, ['class' => 'form-control select-placeholder']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
