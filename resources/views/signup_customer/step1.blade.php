                ...
                <div class="panel panel-default panel-box">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="graduation_year">Graduation Year<i class="required">*</i></label>
                                    {!! Form::select('graduation_year', graduation_year_options(), null, ['class' => 'form-control graduation_year']) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group-checkbox">
                                    <label>
                                        ...
                                        the <a href="{{ route('signup_customer::tos') }}" class="ajax-popup">Terms &
                                            Conditions.</a>
                                    </label>
                                </div>
                            </div>
