...
abstract class Resource implements ResourceInterface
{
    ...
    public function all(array $query = [], $includeMeta = false)
    {
        $all = $this->sendRequest('GET', $this->lob->getVersion(), $this->lob->getClientVersion(), $this->resourceName(), $query, []);
        if ($includeMeta) {
            return $all;
        }
    ...
    {
        return $this->sendRequest('POST', $this->lob->getVersion(), $this->lob->getClientVersion(), $this->resourceName(), [], $data);
    }

    public function get($id)
    {
        return $this->sendRequest('GET', $this->lob->getVersion(), $this->lob->getClientVersion(), $this->resourceName().'/'.strval($id), [], []);
    }

    public function delete($id)
    {
        return $this->sendRequest('DELETE', $this->lob->getVersion(), $this->lob->getClientVersion(), $this->resourceName().'/'.strval($id), [], []);
    }
