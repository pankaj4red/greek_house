...
class OnHoldDesignGenericNotification extends Notification
{
    use Queueable;
    ...
    {
        return $message->subject('Your Order is in Review!')->hello($notifiable->first_name)->line('After further review, our design team rejected your design for one of the following reasons: [ul]'.'[li]Not Enough Information to Complete the Design[/li]'.'[li]Inappropriate Design Request (Greek Licensing Nationals does not allow for these kinds of designs to be used)[/li]'.'[li]Copyright Infringement in Your Design Request[/li]'.'[li]Design is not possible to recreate using screenprinting, sublimation, or embroidery methods[/li][/ul]')->line('Based on the above reasoning do you have another direction you would like to take the design in? If so, please post the new description in the messages.')->line('If not, a member of our team will follow-up and provide additional details. ')->line('You can also schedule a time to talk using this link: [url]https://calendly.com/greekhouse/review[/url]');
    }
