...
class OnHoldDuplicateNotification extends Notification
{
    use Queueable;
    ...
    {
        return $message->subject('Your Order is in Review!')->hello($notifiable->first_name)->line('It looks like you may have placed the same design request twice. Our customer success team is currently checking for duplicates. If this design request was submitted on accident, no worries. Let us know on this message board and we can cancel it out :)');
    }
    ...
    {
        return [
            'notification' => 'on_hold_duplicate_request',
