...
class AdminDashboardTest extends TestCase
{
     ...
     * @test
     */
    public function can_see_admin_dashboard_open()
    {
        // Prepare
        ...
        $admin = UserGenerator::create('admin')->user();
        ...
        $this->assertCount(14, (new Crawler($response->content()))->filter('.nav-tabs .nav-link'));
        ...
        $response->assertSee('/dashboard/delivered');
     ...
     * @test
     */
    public function can_see_admin_dashboard_on_hold()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
     ...
     * @test
     */
    public function can_see_admin_dashboard_design()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
     ...
     * @test
     */
    public function can_see_admin_dashboard_approval()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
     ...
     * @test
     */
    public function can_see_admin_dashboard_revision()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
     ...
     * @test
     */
    public function can_see_admin_dashboard_quote()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
     ...
     * @test
     */
    public function can_see_admin_dashboard_payment()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
     ...
     * @test
     */
    public function can_see_admin_dashboard_fulfillment_ready()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
     ...
     * @test
     */
    public function can_see_admin_dashboard_fulfillment_validation()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
     ...
     * @test
     */
    public function can_see_admin_dashboard_fulfillment_issue()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
     ...
     * @test
     */
    public function can_see_admin_dashboard_printing()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
     ...
     * @test
     */
    public function can_see_admin_dashboard_shipped()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
     ...
     * @test
     */
    public function can_see_admin_dashboard_delivered()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
        ...
        // Execute
        $response = $this->get('/dashboard/delivered');
     ...
     * @test
     */
    public function can_see_admin_dashboard_cancelled()
    {
        // Prepare
        (new \TestingSeeder())->run();
        (new \SupplierSeeder())->run();
